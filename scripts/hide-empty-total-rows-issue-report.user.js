...
(function () {
  ...
  function createGlobalCheckbox() {
    ...
    const splitDiv = document.querySelector(".splitcontent");
    if (!splitDiv) return;
    ...
    splitDiv.parentElement.insertBefore(label, splitDiv);
  ...
  function toggleAllTables(hide = true) {
    const tables = document.querySelectorAll("table.list.issue-report");
